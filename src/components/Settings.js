...
function Settings() {
  ...
  const shareNotificationParams = {
    title: "Copiado",
    message: "Se copió la URL al portapapeles",
    autoClose: 2000,
    color: "green",
  }
  ...
  const startHandler = (e) => {
    ...
    if (!startTitle || !endTitle) {
      alert("Selecciona un valor de la lista")
      return
    }
  ...
  return (
    <Wrapper onSubmit={startHandler}>
      ...
      <SettingDescription>
        Escribe el nombre de un artículo y selecciónalo de la lista que aparecerá o haz click en artículo al azar.
      </SettingDescription>
      ...
      <InputContainer>
        <AutocompleteArticle
          ...
          label="Selecciona artículo incial"
        />
      ...
      <InputContainer>
        <AutocompleteArticle
          ...
          label="Selecciona artículo final"
        />
      ...
      <ButtonContainer>
        <StartButton type="submit">Comenzar</StartButton>
        <ShareButton
          type="button"
          onClick={() => {
